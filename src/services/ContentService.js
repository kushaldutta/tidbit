...
class ContentService {
  ...
  static getCategoryDescription(categoryId) {
    ...
    const descriptions = {
      ...
      'cs61b': 'Data Structures — Java lists, trees, hashing, graphs, and sorting (Hug)',
      'cs161': 'Computer Security — principles, memory safety, crypto, web, and TLS (Wagner / Kao)',
      'cs162': 'Operating Systems — threads, sync, VM, files, and distributed systems (Kubiatowicz / A&D)',
      'cs170': 'Efficient Algorithms — D&C, graphs, greedy, DP, LP, and NP-completeness (Haghtalab / Wright / DPV)',
      'cs186': 'Database Systems — SQL, indexes, QO, transactions, recovery, and NoSQL (Cheung / RookieDB)',
      'cs61c': 'Machine Structures — C, RISC-V, caches, VM, and parallelism (Garcia / P&H)',
      'cs188': 'Artificial Intelligence — search, CSPs, games, MDPs, Bayes nets, and ML (Pierson / Kao / AIMA)',
      'cs189': 'Machine Learning — density, linear models, nets, transformers, and RL (Gonzalez / Norouzi)',
      'math51': 'Calculus I — functions, limits, derivatives, and the FTC',
      'math52': 'Calculus II — techniques of integration, series, and differential equations',
      'math53': 'Multivariable Calculus — partials, multiple integrals, and vector calculus',
      'math55': 'Discrete Mathematics — logic, number theory, counting, and graphs',
      'math104': 'Introduction to Analysis — reals, sequences, continuity, and the Riemann integral',
      'math105': 'Second Course in Analysis — multivariable derivatives, Lebesgue integration, and Fourier series',
      'math110': 'Abstract Linear Algebra — vector spaces, operators, inner products, and Jordan form',
      'math113': 'Abstract Algebra — groups, rings, polynomials, and field extensions',
      ...
      'data-8': 'Foundations of Data Science — tables, simulation, tests, and prediction (Yan / inferential thinking)',
      'data100': 'Principles and Techniques of Data Science',
      'data140': 'Probability for Data Science — distributions, Markov, MCMC, and regression (Adhikari / Pitman)',
      'stat134': 'Concepts of Probability',
      'econ-1': 'Introduction to Economics — scarcity, markets, and macro (Campbell / CORE + OpenStax)',
      'econ100a': 'Microeconomic Theory — consumer/producer theory, GE, games, and information (Campbell)',
      'econ100b': 'Macroeconomic Theory — growth, IS-MP-Phillips, and open economy (Edwards / Jones)',
      'econ101': 'Macroeconomics (Quantitative) — Malthus, Solow, IS-MP-Phillips (Steinsson / 101B)',
      ...
      'chem1b': 'General Chemistry — kinetics, electrochemistry, mixtures, and spectroscopy',
      'chem3a': 'Organic Chemistry — structure, bonding, and reactivity of alkanes through alkynes',
      'eecs16a': 'Signals, systems, and information processing — vectors, DTFS, LS, SVD, LTI (Ayazifar)',
      'eecs16b': 'Introduction to Circuits & Devices — KVL/KCL, RLC, phasors, op-amps (EE 64)',
      'eecs127': 'Optimization models — LS, convexity, duality, KKT, LP/QP (Sojoudi / El Ghaoui)',
      'eecs149': 'Embedded and CPS — FSMs, hybrid, MoCs, RTOS, LTL (Dutta / Seshia)',
      'hist7a': 'US from settlement to Civil War — Native, Atlantic, slavery, democracy (Henkin)',
      'eps7': 'Introduction to Climate Change',
      'math185': 'Introduction to Complex Analysis',
      'ugba101a': 'Microeconomic Analysis for Business Decisions',
